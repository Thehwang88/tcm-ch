...
const wissenBase: Wissen[] = [
  ...
  },
  {
    ...
    "title": "Stress & Burnout: Was Akupunktur realistisch bringt",
  ...
  },
  {
    ...
    "title": "Elektroakupunktur: Wirkung & Ablauf",
    "metaDesc": "Elektroakupunktur verstärkt die Nadelwirkung mit sanftem Strom. Wirkung, Ablauf, Unterschied zu TENS und für wen sie nicht geeignet ist.",
    "region": "Schweizweit",
    "excerpt": "Wie der Strom die Nadelwirkung verstärkt, wann er eingesetzt wird, worin er sich von TENS unterscheidet und für wen er nicht infrage kommt.",
    "category": "TCM in der Schweiz",
    "h1": "Elektroakupunktur: Wenn die Nadel Verstärkung bekommt",
    "lead": "Bei hartnäckigen, chronischen Schmerzen reicht die klassische Nadelung manchmal nicht. Die Elektroakupunktur verstärkt die Stimulation mit sanftem Strom, gut steuerbar, gut untersucht, und mit klaren Regeln, für wen sie nicht passt.",
    "readingTime": "9 Min.",
    ...
    "bodyHtml": "<h2>Was ist Elektroakupunktur?</h2><p>Die Elektroakupunktur beginnt wie jede <a href=\"/therapien/akupunktur/\">Akupunktur</a>: Feine, sterile Nadeln werden in ausgewählte Punkte gesetzt. Dann kommt der Unterschied. An zwei oder mehr Nadeln werden über kleine Klemmen dünne Kabel angeschlossen, und ein Stimulationsgerät schickt einen schwachen, präzise dosierten Strom durch die Nadeln. Spürbar ist das als sanftes Pulsieren, Klopfen oder Kribbeln, dessen Stärke gemeinsam mit dir eingestellt wird.</p><p>Was die Hand der Therapeutin bei der klassischen Akupunktur durch Drehen und Heben der Nadel erreicht, die wiederholte Stimulation des Punkts, übernimmt hier das Gerät: kontinuierlich, gleichmässig und über die ganze Behandlungszeit. Genau dafür wurde die Methode entwickelt, und genau deshalb kommt sie dort zum Einsatz, wo ein kurzer Reiz nicht weit genug trägt. Wie wir das in der Praxis anwenden, liest du auf unserer Seite zur <a href=\"/therapien/elektroakupunktur/\">Elektroakupunktur</a>.</p>\n<h2>Wie wirkt Elektroakupunktur?</h2><p>Interessant ist dabei die Frequenz. In der Grundlagenforschung zeigen niedrige Frequenzen um 2 Hertz und höhere um 100 Hertz unterschiedliche Wirkprofile auf die körpereigene Schmerzhemmung, sie sprechen verschiedene schmerzhemmende Botenstoffe an (<a href=\"https://pubmed.ncbi.nlm.nih.gov/15135942/\" target=\"_blank\" rel=\"noopener\">Han, Neurosci Lett 2004</a>). Deshalb wählt die Therapeutin die Einstellung nach Beschwerdebild: langsames, kräftigeres Pulsieren bei chronischen Schmerzen, feineres Kribbeln bei anderen Bildern. Es geht nie darum, möglichst viel Strom zu spüren, sondern um einen gleichmässigen, angenehmen Reiz.</p><p>Die Elektroakupunktur gehört zu den besser untersuchten Formen der Akupunktur, gerade weil sich die Stimulation standardisieren lässt, ein Vorteil auch für die Forschung. Untersucht ist sie vor allem in der Schmerzbehandlung. Ehrlich bleibt trotzdem: Wie bei aller Akupunkturforschung sind Studienqualität und Effektstärken gemischt. Die Elektroakupunktur ist ein gut begründetes Werkzeug, kein Wundermittel.</p><p>In der Praxis heisst das: Bei chronischen, hartnäckigen und tief sitzenden Schmerzen, dort, wo die klassische Nadelung zwar hilft, aber nicht weit genug trägt, ist die Verstärkung durch Strom oft der Schritt, der den Unterschied macht.</p>\n<h2>Elektroakupunktur oder TENS, was ist der Unterschied?</h2><p>Beide arbeiten mit Strom, aber an verschiedenen Orten. TENS, die transkutane elektrische Nervenstimulation, stimuliert über Klebeelektroden auf der Haut, breitflächig und oberflächlich, und ist als Heimgerät weit verbreitet. Die Elektroakupunktur leitet den Strom über die Nadel direkt an den Akupunkturpunkt, in die Tiefe des Gewebes, punktgenau und kombiniert mit der Nadelwirkung selbst. TENS ist das Alltagswerkzeug für zuhause, die Elektroakupunktur die gezielte Behandlung in der Praxis. Beides schliesst sich nicht aus, und wir sagen dir, wann welches sinnvoll ist.</p><p><strong>Und noch eine Abgrenzung, weil der Name verwirrt.</strong> Die Elektroakupunktur nach Voll, kurz EAV, ist etwas völlig anderes: ein umstrittenes Diagnoseverfahren, das Hautwiderstände misst und daraus Krankheitsaussagen ableitet, ohne wissenschaftliche Grundlage. Das bieten wir nicht an. Wenn wir von Elektroakupunktur sprechen, meinen wir die elektrische Stimulation von Akupunkturnadeln, wie sie international in Kliniken und Studien eingesetzt wird.</p>\n<h2>Wann wird Elektroakupunktur eingesetzt?</h2><p><strong>Chronische Rücken- und Nackenschmerzen.</strong> Das Kerngebiet: tief sitzende, langjährige Schmerzen, bei denen die kontinuierliche Stimulation die Schmerzverarbeitung stärker anspricht als die Nadel allein. Mehr dazu auf unseren Seiten zu <a href=\"/beschwerden/rueckenschmerzen/\">Rückenschmerzen</a> und <a href=\"/beschwerden/nackenschmerzen/\">Nackenschmerzen</a>.</p><p><strong>Arthrose, besonders im Knie.</strong> Die Elektroakupunktur bei Kniearthrose gehört zu den untersuchten Anwendungen; eine Meta-Analyse verschiedener Akupunkturtechniken sieht die Elektrostimulation hier vorne, bei begrenzter Studienqualität (<a href=\"https://pubmed.ncbi.nlm.nih.gov/40620436/\" target=\"_blank\" rel=\"noopener\">Meta-Analyse 2025, PMID 40620436</a>). Eingesetzt wird sie als Baustein der konservativen Behandlung neben Kräftigung und Bewegung, siehe <a href=\"/beschwerden/arthrose/\">Arthrose</a> und <a href=\"/beschwerden/knieschmerzen/\">Knieschmerzen</a>.</p><p><strong>Verhärtete Muskulatur und Triggerpunkte.</strong> Das rhythmische Pulsieren lässt die Muskulatur sichtbar mitarbeiten, viele beschreiben es als tiefe, unwillkürliche Lockerung. Ergänzend dazu arbeiten wir mit <a href=\"/therapien/tuina/\">Tuina</a> und <a href=\"/therapien/physiotherapie/dry-needling/\">Dry Needling</a>.</p><p><strong>Ischias und ausstrahlende Schmerzen.</strong> Bei Nervenreizungen mit Ausstrahlung wird entlang des Verlaufs stimuliert, ergänzend zur ärztlichen Abklärung, die bei Ausfällen immer vorausgeht. Mehr auf der Seite zu <a href=\"/beschwerden/ischias/\">Ischias</a>.</p><p><strong>Hartnäckige Verläufe generell.</strong> Wenn nach mehreren klassischen Sitzungen der Fortschritt stockt, ist der Wechsel auf Elektrostimulation ein üblicher nächster Schritt im Behandlungsplan, kein Zeichen dafür, dass etwas schiefgelaufen ist.</p>\n<h2>Wie fühlt sich die Behandlung an?</h2><p>Die Behandlung dauert wie eine normale Akupunktursitzung 20 bis 30 Minuten mit Strom. Zuerst werden die Nadeln gesetzt, danach einige davon über dünne Kabel mit dem Gerät verbunden. Eingestellt wird immer gemeinsam: Der Strom beginnt bei null und wird langsam erhöht, bis ein deutliches, aber angenehmes Pulsieren oder Klopfen spürbar ist. Schmerzhaft soll es nie sein, und du kannst jederzeit nachjustieren lassen.</p><p>Viele erwarten einen kräftigen Stromschlag und sind überrascht, wie mild sich die Stimulation anfühlt. Gerade das rhythmische Pulsieren empfinden viele als angenehm und tief entspannend, manche schlafen dabei ein. Danach gilt dasselbe wie nach jeder Akupunktur: gelegentlich Müdigkeit, kleine Blutergüsse an der Einstichstelle, selten mehr.</p><p>Eine besondere Vorbereitung braucht es nicht. Komm in bequemer Kleidung, die den zu behandelnden Bereich zugänglich macht, und iss vorher etwas, damit dir während der Sitzung nicht flau wird.</p>\n<h2>Für wen ist Elektroakupunktur nichts?</h2><p>Klare Grenzen gibt es, und sie sind nicht verhandelbar. Bei Herzschrittmachern, implantierten Defibrillatoren und anderen aktiven Implantaten wird keine Elektroakupunktur durchgeführt, der Strom könnte die Geräte stören. Die klassische Akupunktur ohne Strom bleibt in diesen Fällen die sichere Alternative.</p><p>Zurückhaltung gilt ausserdem bei Epilepsie, bei Metallimplantaten im Strompfad, über verletzter oder entzündeter Haut und grundsätzlich im Bereich von Herz und Hals, wo nicht quer stimuliert wird. In der Schwangerschaft behandeln wir klassisch und angepasst, mehr dazu auf der Seite zur <a href=\"/therapien/akupunktur/schwangerschaft/\">Akupunktur in der Schwangerschaft</a>. All das fragen wir vor der ersten Behandlung ab. Sag uns deine Situation, dann wählen wir das passende Werkzeug.</p>\n<h2>Nebenwirkungen und Grenzen</h2><p>Bei fachgerechter Anwendung gilt die Elektroakupunktur als gut verträglich. Möglich sind eine leichte Reizung, ein Ziehen oder ein kleiner blauer Fleck an der Einstichstelle. Wird das Kribbeln unangenehm, wird die Stärke reduziert, nicht ausgehalten.</p><p>Und die Grenze davor: Die Elektroakupunktur ist ein begleitendes Verfahren, kein Ersatz für eine ärztliche Diagnose oder eine notwendige medizinische Behandlung. Bei starken, neuen oder sich verschlechternden Beschwerden gehört immer zuerst die ärztliche Abklärung. Sie wirkt nicht bei jedem gleich, und wir sagen es ehrlich, wenn ein anderer Weg besser passt.</p>\n<h2>Was die Studienlage zeigt</h2><p>Elektroakupunktur ist eine Form der Akupunktur, deshalb ordnet sich ihre Bewertung in die Forschung zur Akupunktur ein. Eine grosse Auswertung von Einzeldaten aus randomisierten Studien zeigte, dass Akupunktur bei chronischen Schmerzen wirksamer war als keine Behandlung und als eine Scheinbehandlung; der Unterschied zur Scheinakupunktur fiel eher klein aus (<a href=\"https://pubmed.ncbi.nlm.nih.gov/29198932/\" target=\"_blank\" rel=\"noopener\">Vickers et al., 2018</a>). Für die Migräneprophylaxe fand eine Cochrane-Übersicht, dass Akupunktur die Anfallshäufigkeit senken kann und mindestens so gut abschneidet wie eine medikamentöse Vorbeugung (<a href=\"https://pubmed.ncbi.nlm.nih.gov/27351677/\" target=\"_blank\" rel=\"noopener\">Linde et al., Cochrane 2016</a>). Für chronische, unspezifische Rückenschmerzen fand eine Cochrane-Übersicht kurzfristig einen kleinen Effekt auf Schmerz und Funktion, bei begrenzter Sicherheit der Evidenz (<a href=\"https://pubmed.ncbi.nlm.nih.gov/33306198/\" target=\"_blank\" rel=\"noopener\">Mu et al., Cochrane 2020</a>).</p><p>Studien speziell zur elektrischen Stimulation sind weniger zahlreich und uneinheitlich. Kurz gesagt: Akupunktur kann bei bestimmten Beschwerden unterstützen, ein Heilversprechen lässt sich daraus nicht ableiten, und das gilt für die Variante mit Strom genauso.</p>\n<h2>Wie viele Sitzungen, und was dazu passt</h2><p>Wie viele Termine sinnvoll sind, hängt davon ab, ob deine Beschwerden akut oder chronisch sind. Bei akuten Themen sind oft einige Sitzungen in kurzem Abstand sinnvoll, bei chronischen Beschwerden eine Begleitung über einen längeren Zeitraum. Nach den ersten Terminen besprechen wir ehrlich, ob die Behandlung etwas bringt und wie es weitergeht.</p><p>Allein steht die Elektroakupunktur dabei selten. Häufig ist sie Teil eines Plans aus klassischer Akupunktur und, wenn passend, weiteren Methoden wie <a href=\"/therapien/tuina/\">Tuina</a> oder <a href=\"/therapien/schroepfen/\">Schröpfen</a>. Soll der Reiz über die Sitzung hinaus wirken, kommen zusätzlich <a href=\"/wissen/dauernadeln-akupunktur/\">Dauernadeln</a> infrage.</p>\n<h2>Elektroakupunktur bei TCM.ch</h2><p>Unsere Therapeutinnen setzen die Elektroakupunktur gezielt dort ein, wo chronische Schmerzen mehr Stimulation brauchen, eingebettet in einen Behandlungsplan mit klaren Messpunkten und ehrlicher Verlaufsbeurteilung. Im Erstgespräch klären wir Eignung, Implantate und Erwartungen. Termine an 14 Standorten in der Deutschschweiz, in der Regel innert 24 bis 48 Stunden.</p>\n<h2>Kosten und Krankenkasse</h2><p>Die Elektroakupunktur ist Teil der Akupunkturbehandlung, keine separate Leistung mit Aufpreis. Es gilt die übliche Regelung: Bei EMR- oder ASCA-anerkannten Therapeutinnen beteiligen sich viele Zusatzversicherungen mit 80 bis 100 Prozent, die Grundversicherung deckt es nicht. Wie die Abrechnung läuft und worauf du bei deiner Police achten solltest, liest du auf unserer Seite zur <a href=\"/krankenkassen/\">Krankenkasse</a>.</p>\n<p><em>Verfasst von Corinna Reinhart, dipl. TCM-Therapeutin mit EMR- und ASCA-Anerkennung.</em></p>",
    "faqs": [
      {
        "q": "Tut Elektroakupunktur weh?",
        "a": "Nein, sie soll es ausdrücklich nicht: Der Strom wird von null langsam hochgeregelt, bis ein deutliches, angenehmes Pulsieren spürbar ist, und bleibt jederzeit anpassbar. Viele empfinden das rhythmische Klopfen als entspannend."
      },
      {
        "q": "Was bringt der Strom zusätzlich zur Nadel?",
        "a": "Er stimuliert den Punkt kontinuierlich über die ganze Sitzung, was die Hand nur punktuell leisten kann, und spricht je nach Frequenz die körpereigene Schmerzhemmung an. Eingesetzt wird das vor allem bei chronischen, hartnäckigen Schmerzen."
      },
      {
        "q": "Ist Elektroakupunktur dasselbe wie TENS?",
        "a": "Nein: TENS stimuliert über Klebeelektroden auf der Haut, die Elektroakupunktur über die Nadel direkt am Punkt in der Tiefe. TENS eignet sich als Heimanwendung, die Elektroakupunktur ist die gezielte Praxisbehandlung."
      },
      {
        "q": "Darf ich mit Herzschrittmacher zur Elektroakupunktur?",
        "a": "Nein, bei Herzschrittmachern und anderen aktiven Implantaten wird nicht elektrisch stimuliert. Die klassische Akupunktur ohne Strom ist dann die sichere Alternative, sag uns dein Implantat vor der ersten Behandlung."
      },
      {
        "q": "Ist das dasselbe wie Elektroakupunktur nach Voll?",
        "a": "Nein. Die EAV ist ein umstrittenes Diagnoseverfahren ohne wissenschaftliche Grundlage und nicht unser Angebot. Unsere Elektroakupunktur ist die elektrische Stimulation von Akupunkturnadeln, wie sie international in Studien und Kliniken eingesetzt wird."
      }
    ],
    "related": [
      {
  ...
  },
  {
    ...
    "title": "Dauernadeln & Akupunkturpflaster: Wirkung, Formen & Risiken",
  ...
  },
  {
    ...
    "title": "Akupunktur bei Rückenschmerzen: Was die Studienlage zeigt",
  ...
  },
  {
    ...
    "related": [
      {
        "href": "/beschwerden/allergien-heuschnupfen/",
        "label": "Heuschnupfen",
        "cat": "Beschwerde"
      },
      {
  ...
  },
  {
    ...
    "title": "Akupunktur bei Migräne: Wirkung, Evidenz & Grenzen",
    "metaDesc": "Akupunktur bei Migräne: bei wem sie hilft, bei wem nicht und was die Studienlage zeigt. Ein ehrlicher Bericht aus drei Jahren Behandlung in unseren TCM-Kliniken.", "region": "Schweizweit", "excerpt": "Ein ehrlicher Bericht aus drei Jahren Migräne-Behandlungen, und was wir Patientinnen heute anders sagen als früher.",
    "category": "Beschwerden verstehen",
  ...
  },
  {
    ...
    "title": "Akupunktur bei PCOS: Wirkung, Evidenz und Grenzen",
    ...
    "category": "Beschwerden verstehen",
    "h1": "Akupunktur bei PCOS: Wirkung, Evidenz und Grenzen",
  ...
  },
  {
    ...
    "title": "Akupunktur bei IVF & Kinderwunschbehandlung: Zeitpunkt und Ablauf",
    "metaDesc": "Akupunktur begleitend zur Kinderwunschbehandlung: Timing rund um IVF, ICSI und Embryotransfer, Frequenz und realistische Einordnung. Der praktische Ablauf-Guide.",
    "region": "Schweizweit",
    "excerpt": "Der praktische Guide zum Ablauf: wann beginnen, wie oft behandeln und wie sich Akupunktur zeitlich rund um IVF, ICSI und Embryotransfer einordnen lässt.",
    "category": "Beschwerden verstehen",
    "h1": "Akupunktur bei IVF und Kinderwunschbehandlung: Zeitpunkt und Ablauf",
    "lead": "Du hast dich für eine Begleitung mit Akupunktur entschieden oder überlegst es dir: Dieser Guide beantwortet die praktischen Fragen. Wann beginnt man idealerweise, wie oft finden Behandlungen statt, und wie sieht das Timing rund um IVF, ICSI und Embryotransfer aus. Ohne Erfolgsversprechen, dafür mit einem realistischen Fahrplan.",
    "readingTime": "6 Min.",
  ...
  },
  {
    ...
    "title": "TCM in Luzern: Ablauf, Erfahrungen & was dich erwartet",
    ...
    "category": "Standorte",
    "h1": "TCM in Luzern: Wie eine Behandlung abläuft und was dich erwartet",
  ...
  },
  {
    ...
    "title": "TCM in Basel: Ablauf, Erfahrungen & was dich erwartet",
    ...
    "category": "Standorte",
    "h1": "TCM in Basel: Wie eine Behandlung abläuft und was dich erwartet",
  ...
  {
    "slug": "tcm-kreuzlingen-erfahrungen-ablauf",
    "title": "TCM in Kreuzlingen: Ablauf, Erfahrungen & was dich erwartet",
    "metaDesc": "Wie eine TCM-Behandlung in Kreuzlingen abläuft: Erstgespräch, Puls- und Zungenbefund, Kosten nach Tarif 590 und was die Studien zu Akupunktur wirklich zeigen.",
    "region": "Kreuzlingen",
    "excerpt": "Ablauf der Erstbehandlung, Studienlage, Kosten und was Patient:innen aus Konstanz zur Abrechnung wissen müssen.",
    "category": "Standorte",
    "h1": "TCM in Kreuzlingen: Wie eine Behandlung abläuft und was dich erwartet",
    "lead": "Erstgespräch, Befund, Behandlungsplan: Was in einer TCM-Praxis am Bodensee tatsächlich passiert, was die Studien dazu sagen, was es kostet und wann du besser zuerst ärztlich abklären lässt.",
    "readingTime": "9 Min.",
    "ctaTitle": "Termin in Kreuzlingen anfragen",
    "author": {
      "name": "Corinna Reinhart",
      "role": "TCM-Therapeutin · EMR & ASCA zertifiziert · Praxis St. Gallen",
      "bio": "Corinna behandelt seit über zwölf Jahren Patientinnen mit Akupunktur, Tuina und Schröpfen. Schwerpunkte: chronische Schmerzen, Kopfschmerzen, Migräne und stressbedingte Beschwerden. Ausbildung in der Schweiz mit Weiterbildungen in Chengdu und Shanghai. Arbeitet eng mit Neurologen und Gynäkologinnen in der Ostschweiz zusammen."
    ...
    "bodyHtml": "<p>Kurz gesagt: Du startest mit einem ausführlichen Gespräch, bekommst einen Befund nach Puls und Zunge, und daraus entsteht dein Behandlungsplan. Eine Sitzung kostet rund 130 bis 160 Franken, die Zusatzversicherung übernimmt je nach Modell 80 bis 100 Prozent. Was die Studien hergeben, wo die Grenzen liegen und was du als Patient:in aus Konstanz beachten musst, steht weiter unten.</p>\n<p>Die meisten Menschen, die zum ersten Mal in eine TCM-Praxis gehen, haben vorher schon einiges probiert. Physiotherapie, Schmerzmittel, ein MRI, das nichts Auffälliges zeigt. Was fehlt, ist eine Vorstellung davon, was in der Praxis eigentlich passiert. Genau darum geht es hier, ohne Werbesprache und mit den Zahlen, die wir auch am Telefon nennen. Wenn du danach wissen willst, wer bei uns behandelt und wie du hinkommst, findest du das unter <a href=\"/standorte/kreuzlingen/\">TCM Kreuzlingen</a>.</p>\n<h2>Wie eine Erstbehandlung abläuft</h2>\n<p>Der erste Termin dauert bei uns rund 60 Minuten, in komplexeren Fällen bis zu 90. Der grösste Teil davon ist Gespräch. Wir wollen wissen, seit wann die Beschwerden bestehen, was sie besser und was sie schlechter macht, wie du schläfst, wie du isst, wie es im Job und zuhause läuft und welche Untersuchungen es schon gab. Das ist kein Small Talk, sondern der Teil, aus dem sich der Behandlungsplan ergibt.</p>\n<p>Danach folgt die Untersuchung. Dazu gehört das Abtasten der schmerzhaften Region, ein Blick auf Beweglichkeit und Haltung sowie die beiden klassischen Verfahren der chinesischen Medizin: der Puls an beiden Handgelenken und die Betrachtung der Zunge. Beides sind Befunde innerhalb des TCM-Modells, keine Laborwerte. Wer dir aus dem Puls eine Diagnose wie \"Schilddrüsenunterfunktion\" liest, überschreitet, was das Verfahren hergibt.</p>\n<p>Erst danach wird behandelt. Meist werden acht bis zwanzig sterile Einmalnadeln gesetzt, die 20 bis 30 Minuten liegen bleiben. Viele Menschen dösen in dieser Zeit weg. Je nach Befund kommt Tuina dazu, also manuelle Techniken an Muskulatur und Gelenken, Schröpfen, Gua Sha oder Moxibustion, bei der ein Punkt kontrolliert erwärmt wird. Zum Schluss besprechen wir, was du erwarten kannst, wie viele Termine sinnvoll erscheinen und was das kostet.</p>\n<p>Nach der ersten Sitzung fühlen sich viele angenehm müde, manche berichten von leichtem Schwindel oder kurzzeitig stärkeren Beschwerden. Beides ist harmlos und legt sich meist innert eines Tages. Blaue Flecken an den Einstichstellen kommen vor, Schröpfen hinterlässt für einige Tage runde Male. Plan den Abend danach also nicht zu voll.</p>\n<h2>Was die Studienlage hergibt</h2>\n<p>Akupunktur ist besser untersucht, als viele denken, und schwächer belegt, als manche Praxis behauptet. Beides gehört zusammen. Die grösste Auswertung stammt von Vickers und Kollegen, die Individualdaten von rund 21'000 Patient:innen aus 39 kontrollierten Studien zusammengeführt haben. Ergebnis: Bei chronischen Schmerzen, also Rücken, Nacken, Schulter, Knie und Kopfschmerz, wirkt Akupunktur besser als keine Behandlung, und auch etwas besser als Scheinakupunktur. Der Unterschied zur Scheinakupunktur ist real, aber klein. Der Unterschied zu gar keiner Behandlung ist deutlich.</p>\n<p>Für Migräne kommt der Cochrane-Review von Linde und Kollegen zu einem ähnlichen Bild: Akupunktur reduziert die Zahl der Migränetage und ist einer prophylaktischen Medikation zumindest ebenbürtig, bei weniger Nebenwirkungen. Für Spannungskopfschmerzen und für Kniearthrose existiert vergleichbare Evidenz. Für Übelkeit nach Operationen und in der Schwangerschaft ist die Datenlage ebenfalls solide.</p>\n<p>Deutlich dünner wird es bei allem, was darüber hinausgeht. Für Tinnitus, Allergien, Verdauungsbeschwerden oder Erschöpfung gibt es einzelne positive Studien, aber keine belastbare Gesamtaussage. Für chinesische Kräuterrezepturen ist die Studienlage uneinheitlich, unter anderem weil jede Mischung individuell ist und sich schlecht standardisieren lässt. Und für ernsthafte organische Erkrankungen ist Akupunktur keine Therapie, sondern höchstens Begleitung.</p>\n<p>Ehrlich gesagt ist der praktisch wichtigste Punkt ein anderer: Ob eine Behandlung bei dir anschlägt, siehst du schneller, als jede Studie es vorhersagen kann. Nach vier bis sechs Terminen weisst du in der Regel, ob sich etwas bewegt.</p>\n<h2>Rote Flaggen: wann zuerst zur Ärztin</h2>\n<p>Es gibt Situationen, in denen eine TCM-Praxis der falsche erste Anlaufpunkt ist. Wir sagen das offen, weil es sonst niemand tut. Geh zuerst ärztlich abklären oder in den Notfall bei:</p>\n<ul>\n<li>plötzlich einsetzenden, sehr starken Schmerzen, besonders im Brustkorb oder im Bauch</li>\n<li>Lähmungen, Taubheitsgefühl in Reithosenform, Kontrollverlust über Blase oder Darm</li>\n<li>Schmerzen mit Fieber, Nachtschweiss oder ungewolltem Gewichtsverlust</li>\n<li>dem stärksten Kopfschmerz deines Lebens oder neu auftretenden neurologischen Ausfällen</li>\n<li>Blut im Stuhl oder Urin, unklaren Blutungen</li>\n<li>Beschwerden nach einem Sturz oder Unfall, solange ein Bruch nicht ausgeschlossen ist</li>\n</ul>\n<p>Auch bei bekannten Vorerkrankungen gilt Vorsicht statt Mut: Bei Blutgerinnungsstörungen oder unter Blutverdünnern wird zurückhaltender genadelt, bei akuten Infekten und offenen Wunden gar nicht im betroffenen Gebiet, in der Schwangerschaft werden bestimmte Punkte gemieden. Sag uns solche Dinge ungefragt, auch wenn du sie für unwichtig hältst.</p>\n<p>Und noch etwas: Eine seriöse Praxis rät dir nie, ärztlich verordnete Medikamente abzusetzen, weil die Behandlung wirkt. Wenn dir das jemand nahelegt, ist das ein Grund zu gehen, nicht ein Zeichen von Überzeugung.</p>\n<h2>Was eine Behandlung kostet</h2>\n<p>Abgerechnet wird nach dem anerkannten <strong>Tarif 590</strong>, nach Behandlungsdauer in Zeiteinheiten von fünf Minuten. Eine Folgesitzung liegt damit bei rund 130 bis 160 Franken. Das Erstgespräch dauert länger und liegt entsprechend höher. Chinesische Kräuter kommen separat dazu, weil jede Rezeptur individuell gemischt wird.</p>\n<p>Bezahlt wird das über die <strong>Zusatzversicherung</strong> für Komplementärmedizin, nie über die Grundversicherung. Je nach Modell und Jahreslimite trägt die Kasse 80 bis 100 Prozent der Sitzung. Voraussetzung ist die EMR- oder ASCA-Anerkennung der behandelnden Person, eine ärztliche Überweisung brauchst du dafür nicht. Ohne Zusatzversicherung zahlst du selbst, zu denselben Tarifen und ohne Aufschlag.</p>\n<p>Die vollständige Aufstellung mit den gängigen Kassen und Modellen findest du unter <a href=\"/standorte/kreuzlingen/kosten/\">Kosten und Krankenkasse in Kreuzlingen</a>.</p>\n<h2>Wenn du aus Deutschland anreist</h2>\n<p>Ein guter Teil unserer Patient:innen wohnt auf der anderen Seite der Grenze, in Konstanz und Umgebung. Von dort bis zu uns sind es wenige Minuten. Praktisch ist das unkompliziert, versicherungstechnisch lohnt sich ein genauer Blick, bevor du den ersten Termin nimmst.</p>\n<p>Behandelt wird in der Schweiz, abgerechnet nach Schweizer Tarif. Wer als Grenzgänger:in hier arbeitet und in der Schweiz grundversichert ist, kann eine <strong>Zusatzversicherung für Komplementärmedizin</strong> abschliessen und die Rechnung genauso einreichen wie alle anderen. Massgeblich ist dabei nicht dein Wohnort, sondern deine Police. Wichtig zu wissen: Eine solche Zusatzversicherung wird beim Abschluss geprüft und lässt sich nicht rückwirkend für bereits erfolgte Behandlungen aktivieren.</p>\n<p>Bist du in Deutschland gesetzlich versichert, sieht es anders aus. Die gesetzlichen Kassen erstatten Akupunktur nur bei bestimmten Indikationen und nur bei Ärzt:innen mit entsprechender Qualifikation, eine Behandlung bei Therapeut:innen im Ausland fällt in der Regel nicht darunter. Private Tarife und Zusatztarife decken teilweise mehr, das steht in deinen Bedingungen unter Heilpraktikerleistungen. Ohne Deckung zahlst du selbst, zu denselben Preisen wie alle anderen und ohne Zuschlag.</p>\n<p>Du bekommst von uns in jedem Fall eine detaillierte Rechnung mit Tarifpositionen und ZSR-Nummer, mit der du bei deinem Versicherer einreichen kannst. Frag vor dem ersten Termin kurz nach, wir sagen dir, was in deiner Konstellation realistisch ist, statt dich hinterher mit einer Absage dastehen zu lassen.</p>\n<h2>Wie viele Termine realistisch sind</h2>\n<p>Die ehrliche Antwort lautet: Das weiss vor dem ersten Termin niemand, und wer dir eine Zahl nennt, bevor er dich untersucht hat, rät. Was sich sagen lässt, sind Erfahrungswerte. Akute Beschwerden, ein eingeklemmter Nacken, ein akuter Hexenschuss, ein frischer Infekt, brauchen oft nur vier bis sechs Sitzungen, anfangs zwei pro Woche. Chronische Muster, die seit Jahren bestehen, brauchen realistisch acht bis zwölf Termine, bevor sich etwas stabil verändert.</p>\n<p>Wichtiger als die Gesamtzahl ist der Zwischenstopp. Wir setzen nach vier Sitzungen bewusst einen Punkt und schauen gemeinsam: Hat sich die Schmerzintensität verändert, die Häufigkeit der Attacken, die Schlafqualität, die Zahl der Tage, an denen du Medikamente brauchst? Wenn sich nichts davon bewegt hat, ist das ein Ergebnis. Dann besprechen wir, ob eine andere Methode passt oder ob du mit dem Anliegen besser woanders aufgehoben bist. Was wir nicht machen: eine Serie weiterlaufen lassen, weil sie einmal begonnen wurde.</p>\n<p>Danach geht es für viele in einen ruhigeren Rhythmus über, alle vier bis acht Wochen, oft saisonal. Das ist kein Abo und keine Verpflichtung, sondern schlicht das Intervall, in dem sich der Effekt bei den meisten hält.</p>\n<h2>Woran du eine seriöse Praxis erkennst</h2>\n<p>Die Berufsbezeichnung ist in der Schweiz nicht geschützt, die Abrechnung über die Zusatzversicherung schon. Genau daran kannst du dich orientieren. Wer im <strong>EMR</strong> registriert ist oder eine ASCA-Anerkennung hat, hat eine geprüfte Ausbildung, ausreichend Praxisstunden und laufende Fortbildung nachgewiesen. Frag im Zweifel nach der ZSR-Nummer, das ist eine legitime Frage und keine Unhöflichkeit.</p>\n<p>Zweiter Punkt: die Anamnese. Wer dich nach fünf Minuten auf die Liege legt, kann keinen Plan haben. Dritter Punkt: die Preisauskunft. Was eine Sitzung kostet und was die Kasse voraussichtlich trägt, muss vor der ersten Behandlung auf dem Tisch liegen, nicht danach.</p>\n<p>Und der vierte, der am meisten aussagt: Sagt dir jemand, wann seine Methode nicht das Richtige ist? Eine Praxis, bei der alles behandelbar ist, behandelt nichts besonders gut. Wir schicken regelmässig Leute zur Physiotherapie, zur Neurologin oder zur Hausärztin weiter, und das ist kein verlorener Termin, sondern der Teil der Arbeit, der am längsten trägt.</p>\n<p>Und wenn du das alles gelesen hast und immer noch unsicher bist, ob dein Anliegen dazu passt: Schreib uns kurz, was los ist. Wir sagen dir ehrlich, ob sich ein Termin lohnt, und wenn nicht, wohin du besser gehst. Alle Angaben zu Adresse, Team und Öffnungszeiten stehen auf der Seite zu <a href=\"/standorte/kreuzlingen/\">Akupunktur Kreuzlingen</a>.</p>",
    "faqs": [
      {
        "q": "Tut Akupunktur weh?",
        "a": "Die Nadeln sind etwa so dick wie ein Haar. Beim Setzen spürst du meist einen kurzen Pieks, danach oft ein dumpfes Ziehen oder Schweregefühl rund um den Punkt. Das ist gewollt und legt sich innert Sekunden. Anhaltender, scharfer Schmerz gehört nicht dazu: Sag Bescheid, die Nadel wird sofort korrigiert oder entfernt."
      },
      {
        "q": "Was soll ich zum ersten Termin mitbringen?",
        "a": "Eine Liste deiner Medikamente und Nahrungsergänzungsmittel, vorhandene Befunde wie MRI-, Röntgen- oder Laborberichte und die Angaben zu deiner Zusatzversicherung. Zieh etwas an, das sich leicht hochschieben lässt. Und plan etwas Zeit ein, das Erstgespräch dauert länger als ein Folgetermin."
      },
      {
        "q": "Kann ich TCM mit einer laufenden ärztlichen Behandlung kombinieren?",
        "a": "In den allermeisten Fällen ja, und oft ist genau das sinnvoll. Wichtig ist, dass wir von deiner ärztlichen Therapie wissen, besonders bei Blutverdünnern, Immunsuppressiva, Chemotherapie oder einer Schwangerschaft. Setz nie eigenmächtig Medikamente ab, weil eine Behandlung anschlägt. Das besprichst du mit der verschreibenden Ärztin."
      },
      {
        "q": "Was unterscheidet Tuina von einer klassischen Massage?",
        "a": "Tuina arbeitet nicht flächig entspannend, sondern gezielt an einzelnen Punkten, Sehnenansätzen und Gelenken, mit Druck-, Schiebe- und Dehntechniken. Es kann phasenweise deutlich intensiver sein als eine Wellnessmassage und wird meist als Teil eines Behandlungsplans eingesetzt, nicht als einmalige Wohltat."
      },
      {
        "q": "Woran erkenne ich eine seriöse TCM-Praxis?",
        "a": "An der Registrierung im EMR oder bei der ASCA, an einer nachvollziehbaren Anamnese, an klaren Preisangaben vor der Behandlung und daran, dass dir jemand sagt, wenn eine Methode bei deinem Anliegen wenig bringt. Unseriös wird es bei Heilversprechen, bei Paketen, die du im Voraus kaufen sollst, und beim Rat, ärztliche Therapien abzusetzen."
      }
    ],
    "related": [
      {
        "href": "/standorte/kreuzlingen/",
        "label": "Standort Kreuzlingen",
        "cat": "Standort"
      },
      {
        "href": "/standorte/kreuzlingen/kosten/",
        "label": "Kosten & Krankenkasse",
        "cat": "Kosten"
      },
      {
        "href": "/wissen/krankenkasse-tcm-was-wirklich-uebernommen-wird-2026/",
  ...
  {
    "slug": "tcm-frauenfeld-erfahrungen-ablauf",
    "title": "TCM in Frauenfeld: Ablauf, Erfahrungen & was dich erwartet",
    "metaDesc": "Wie eine TCM-Behandlung in Frauenfeld abläuft: Erstgespräch, Puls- und Zungenbefund, Kosten nach Tarif 590 und was die Studien zu Akupunktur wirklich zeigen.",
    "region": "Frauenfeld",
    "excerpt": "Ablauf der Erstbehandlung, Studienlage, Kosten und wie viele Termine im mittleren Thurgau realistisch sind.",
    "category": "Standorte",
    "h1": "TCM in Frauenfeld: Wie eine Behandlung abläuft und was dich erwartet",
    "lead": "Erstgespräch, Befund, Behandlungsplan: Was in einer TCM-Praxis im Thurgau tatsächlich passiert, was die Studien dazu sagen, was es kostet und wann du besser zuerst ärztlich abklären lässt.",
    "readingTime": "9 Min.",
    "ctaTitle": "Termin in Frauenfeld anfragen",
    "author": {
      "name": "Corinna Reinhart",
      "role": "TCM-Therapeutin · EMR & ASCA zertifiziert · Praxis St. Gallen",
      "bio": "Corinna behandelt seit über zwölf Jahren Patientinnen mit Akupunktur, Tuina und Schröpfen. Schwerpunkte: chronische Schmerzen, Kopfschmerzen, Migräne und stressbedingte Beschwerden. Ausbildung in der Schweiz mit Weiterbildungen in Chengdu und Shanghai. Arbeitet eng mit Neurologen und Gynäkologinnen in der Ostschweiz zusammen."
    ...
    "dateModified": "2026-08-20",
    "lastReviewed": "2026-08-20",
    "bodyHtml": "<p>Kurz gesagt: Du startest mit einem ausführlichen Gespräch, bekommst einen Befund nach Puls und Zunge, und daraus entsteht dein Behandlungsplan. Eine Sitzung kostet rund 130 bis 160 Franken, die Zusatzversicherung übernimmt je nach Modell 80 bis 100 Prozent. Was die Studien hergeben, wo die Grenzen liegen und wie viele Termine realistisch sind, steht weiter unten.</p>\n<p>Wer zum ersten Mal einen Termin in einer TCM-Praxis nimmt, hat meist schon eine Runde hinter sich: Physiotherapie, Schmerzmittel, ein Befund, der nichts Eindeutiges zeigt. Was fehlt, ist eine konkrete Vorstellung davon, was in der Praxis passiert und was man erwarten darf. Genau darum geht es hier, mit denselben Zahlen, die wir auch am Telefon nennen. Wer bei uns behandelt und wie du hinkommst, steht unter <a href=\"/standorte/frauenfeld/\">TCM Frauenfeld</a>.</p>\n<h2>Wie eine Erstbehandlung abläuft</h2>\n<p>Der erste Termin dauert bei uns rund 60 Minuten, in komplexeren Fällen bis zu 90. Der grösste Teil davon ist Gespräch. Wir wollen wissen, seit wann die Beschwerden bestehen, was sie besser und was sie schlechter macht, wie du schläfst, wie du isst, wie es im Job und zuhause läuft und welche Untersuchungen es schon gab. Das ist kein Small Talk, sondern der Teil, aus dem sich der Behandlungsplan ergibt.</p>\n<p>Danach folgt die Untersuchung. Dazu gehört das Abtasten der schmerzhaften Region, ein Blick auf Beweglichkeit und Haltung sowie die beiden klassischen Verfahren der chinesischen Medizin: der Puls an beiden Handgelenken und die Betrachtung der Zunge. Beides sind Befunde innerhalb des TCM-Modells, keine Laborwerte. Wer dir aus dem Puls eine Diagnose wie \"Schilddrüsenunterfunktion\" liest, überschreitet, was das Verfahren hergibt.</p>\n<p>Erst danach wird behandelt. Meist werden acht bis zwanzig sterile Einmalnadeln gesetzt, die 20 bis 30 Minuten liegen bleiben. Viele Menschen dösen in dieser Zeit weg. Je nach Befund kommt Tuina dazu, also manuelle Techniken an Muskulatur und Gelenken, Schröpfen, Gua Sha oder Moxibustion, bei der ein Punkt kontrolliert erwärmt wird. Zum Schluss besprechen wir, was du erwarten kannst, wie viele Termine sinnvoll erscheinen und was das kostet.</p>\n<p>Nach der ersten Sitzung fühlen sich viele angenehm müde, manche berichten von leichtem Schwindel oder kurzzeitig stärkeren Beschwerden. Beides ist harmlos und legt sich meist innert eines Tages. Blaue Flecken an den Einstichstellen kommen vor, Schröpfen hinterlässt für einige Tage runde Male. Plan den Abend danach also nicht zu voll.</p>\n<h2>Was die Studienlage hergibt</h2>\n<p>Akupunktur ist besser untersucht, als viele denken, und schwächer belegt, als manche Praxis behauptet. Beides gehört zusammen. Die grösste Auswertung stammt von Vickers und Kollegen, die Individualdaten von rund 21'000 Patient:innen aus 39 kontrollierten Studien zusammengeführt haben. Ergebnis: Bei chronischen Schmerzen, also Rücken, Nacken, Schulter, Knie und Kopfschmerz, wirkt Akupunktur besser als keine Behandlung, und auch etwas besser als Scheinakupunktur. Der Unterschied zur Scheinakupunktur ist real, aber klein. Der Unterschied zu gar keiner Behandlung ist deutlich.</p>\n<p>Für Migräne kommt der Cochrane-Review von Linde und Kollegen zu einem ähnlichen Bild: Akupunktur reduziert die Zahl der Migränetage und ist einer prophylaktischen Medikation zumindest ebenbürtig, bei weniger Nebenwirkungen. Für Spannungskopfschmerzen und für Kniearthrose existiert vergleichbare Evidenz. Für Übelkeit nach Operationen und in der Schwangerschaft ist die Datenlage ebenfalls solide.</p>\n<p>Deutlich dünner wird es bei allem, was darüber hinausgeht. Für Tinnitus, Allergien, Verdauungsbeschwerden oder Erschöpfung gibt es einzelne positive Studien, aber keine belastbare Gesamtaussage. Für chinesische Kräuterrezepturen ist die Studienlage uneinheitlich, unter anderem weil jede Mischung individuell ist und sich schlecht standardisieren lässt. Und für ernsthafte organische Erkrankungen ist Akupunktur keine Therapie, sondern höchstens Begleitung.</p>\n<p>Ehrlich gesagt ist der praktisch wichtigste Punkt ein anderer: Ob eine Behandlung bei dir anschlägt, siehst du schneller, als jede Studie es vorhersagen kann. Nach vier bis sechs Terminen weisst du in der Regel, ob sich etwas bewegt.</p>\n<h2>Rote Flaggen: wann zuerst zur Ärztin</h2>\n<p>Es gibt Situationen, in denen eine TCM-Praxis der falsche erste Anlaufpunkt ist. Wir sagen das offen, weil es sonst niemand tut. Geh zuerst ärztlich abklären oder in den Notfall bei:</p>\n<ul>\n<li>plötzlich einsetzenden, sehr starken Schmerzen, besonders im Brustkorb oder im Bauch</li>\n<li>Lähmungen, Taubheitsgefühl in Reithosenform, Kontrollverlust über Blase oder Darm</li>\n<li>Schmerzen mit Fieber, Nachtschweiss oder ungewolltem Gewichtsverlust</li>\n<li>dem stärksten Kopfschmerz deines Lebens oder neu auftretenden neurologischen Ausfällen</li>\n<li>Blut im Stuhl oder Urin, unklaren Blutungen</li>\n<li>Beschwerden nach einem Sturz oder Unfall, solange ein Bruch nicht ausgeschlossen ist</li>\n</ul>\n<p>Auch bei bekannten Vorerkrankungen gilt Vorsicht statt Mut: Bei Blutgerinnungsstörungen oder unter Blutverdünnern wird zurückhaltender genadelt, bei akuten Infekten und offenen Wunden gar nicht im betroffenen Gebiet, in der Schwangerschaft werden bestimmte Punkte gemieden. Sag uns solche Dinge ungefragt, auch wenn du sie für unwichtig hältst.</p>\n<p>Und noch etwas: Eine seriöse Praxis rät dir nie, ärztlich verordnete Medikamente abzusetzen, weil die Behandlung wirkt. Wenn dir das jemand nahelegt, ist das ein Grund zu gehen, nicht ein Zeichen von Überzeugung.</p>\n<h2>Was eine Behandlung kostet</h2>\n<p>Abgerechnet wird nach dem anerkannten <strong>Tarif 590</strong>, nach Behandlungsdauer in Zeiteinheiten von fünf Minuten. Eine Folgesitzung liegt damit bei rund 130 bis 160 Franken. Das Erstgespräch dauert länger und liegt entsprechend höher. Chinesische Kräuter kommen separat dazu, weil jede Rezeptur individuell gemischt wird.</p>\n<p>Bezahlt wird das über die <strong>Zusatzversicherung</strong> für Komplementärmedizin, nie über die Grundversicherung. Je nach Modell und Jahreslimite trägt die Kasse 80 bis 100 Prozent der Sitzung. Voraussetzung ist die EMR- oder ASCA-Anerkennung der behandelnden Person, eine ärztliche Überweisung brauchst du dafür nicht. Ohne Zusatzversicherung zahlst du selbst, zu denselben Tarifen und ohne Aufschlag.</p>\n<p>Die vollständige Aufstellung mit den gängigen Kassen und Modellen findest du unter <a href=\"/standorte/frauenfeld/kosten/\">Kosten und Krankenkasse in Frauenfeld</a>.</p>\n<h2>Was das für die Region bedeutet</h2>\n<p>Der mittlere Thurgau ist komplementärmedizinisch dünner besetzt als der Grossraum Zürich. Wer ein volles Behandlungsspektrum sucht, also nicht nur Nadeln, sondern auch Tuina, Schröpfen, Moxibustion und Kräuterrezepturen aus einer Hand, ist bisher oft nach Winterthur oder Zürich gefahren. Das ist mit ein Grund, warum bei uns viele Patient:innen aus Weinfelden, Aadorf, Matzingen und der Region Wil sitzen: nicht, weil es nichts anderes gäbe, sondern weil die Wege kurz sind und die Behandlung an einem Ort stattfindet.</p>\n<p>Praktisch heisst das zweierlei. Erstens: Termine sind hier weniger knapp als in der Stadt, oft geht etwas innert 24 bis 48 Stunden. Zweitens: Die Zusammenarbeit mit Hausärzt:innen und Physiotherapien in der Umgebung läuft direkter. Wenn eine Abklärung ansteht oder eine Behandlung besser in andere Hände gehört, ist der Weg dorthin kurz, und das kommt öfter vor, als man denkt.</p>\n<p>Für die Anreise ist der Bahnhof der praktischste Bezugspunkt: Die S30 verbindet Winterthur, Frauenfeld und Romanshorn, die Frauenfeld-Wil-Bahn führt direkt aus dem Raum Wil hierher. Aus Weinfelden bist du in gut einer Viertelstunde da.</p>\n<p>Drittens verschiebt sich damit auch, wer überhaupt kommt. In der Stadt sitzen in einer TCM-Praxis auffällig viele Menschen mit Bildschirmarbeit und Nackenbeschwerden. Hier ist die Mischung breiter: Handwerk, Landwirtschaft, Pflege, Schichtarbeit, dazu viele, die den Rücken über Jahrzehnte belastet haben und nicht auf eine schnelle Lösung hoffen, sondern auf ein paar Grad mehr Beweglichkeit im Alltag. Das verändert die Behandlung. Es geht seltener um Entspannung und häufiger darum, eine belastete Struktur so weit zu beruhigen, dass die Arbeit am Montag wieder geht. Genau deshalb planen wir Termine hier oft am frühen Morgen oder am späten Abend, und deshalb steht am Ende jeder Serie die Frage, was du selbst zwischen den Terminen tun kannst, statt alle vier Wochen wiederzukommen.</p>\n<h2>Wie viele Termine realistisch sind</h2>\n<p>Die ehrliche Antwort lautet: Das weiss vor dem ersten Termin niemand, und wer dir eine Zahl nennt, bevor er dich untersucht hat, rät. Was sich sagen lässt, sind Erfahrungswerte. Akute Beschwerden, ein eingeklemmter Nacken, ein akuter Hexenschuss, ein frischer Infekt, brauchen oft nur vier bis sechs Sitzungen, anfangs zwei pro Woche. Chronische Muster, die seit Jahren bestehen, brauchen realistisch acht bis zwölf Termine, bevor sich etwas stabil verändert.</p>\n<p>Wichtiger als die Gesamtzahl ist der Zwischenstopp. Wir setzen nach vier Sitzungen bewusst einen Punkt und schauen gemeinsam: Hat sich die Schmerzintensität verändert, die Häufigkeit der Attacken, die Schlafqualität, die Zahl der Tage, an denen du Medikamente brauchst? Wenn sich nichts davon bewegt hat, ist das ein Ergebnis. Dann besprechen wir, ob eine andere Methode passt oder ob du mit dem Anliegen besser woanders aufgehoben bist. Was wir nicht machen: eine Serie weiterlaufen lassen, weil sie einmal begonnen wurde.</p>\n<p>Danach geht es für viele in einen ruhigeren Rhythmus über, alle vier bis acht Wochen, oft saisonal. Das ist kein Abo und keine Verpflichtung, sondern schlicht das Intervall, in dem sich der Effekt bei den meisten hält.</p>\n<h2>Woran du eine seriöse Praxis erkennst</h2>\n<p>Die Berufsbezeichnung ist in der Schweiz nicht geschützt, die Abrechnung über die Zusatzversicherung schon. Genau daran kannst du dich orientieren. Wer im <strong>EMR</strong> registriert ist oder eine ASCA-Anerkennung hat, hat eine geprüfte Ausbildung, ausreichend Praxisstunden und laufende Fortbildung nachgewiesen. Frag im Zweifel nach der ZSR-Nummer, das ist eine legitime Frage und keine Unhöflichkeit.</p>\n<p>Zweiter Punkt: die Anamnese. Wer dich nach fünf Minuten auf die Liege legt, kann keinen Plan haben. Dritter Punkt: die Preisauskunft. Was eine Sitzung kostet und was die Kasse voraussichtlich trägt, muss vor der ersten Behandlung auf dem Tisch liegen, nicht danach.</p>\n<p>Und der vierte, der am meisten aussagt: Sagt dir jemand, wann seine Methode nicht das Richtige ist? Eine Praxis, bei der alles behandelbar ist, behandelt nichts besonders gut. Wir schicken regelmässig Leute zur Physiotherapie, zur Neurologin oder zur Hausärztin weiter, und das ist kein verlorener Termin, sondern der Teil der Arbeit, der am längsten trägt.</p>\n<p>Bleibt die Frage, ob dein Anliegen überhaupt dazu passt. Schreib uns kurz, was los ist. Wir sagen dir ehrlich, ob ein Termin sinnvoll ist, und wenn nicht, wohin du besser gehst. Adresse, Team und Öffnungszeiten findest du auf der Seite zu <a href=\"/standorte/frauenfeld/\">Akupunktur Frauenfeld</a>.</p>",
    "faqs": [
      {
        "q": "Tut Akupunktur weh?",
        "a": "Die Nadeln sind etwa so dick wie ein Haar. Beim Setzen spürst du meist einen kurzen Pieks, danach oft ein dumpfes Ziehen oder Schweregefühl rund um den Punkt. Das ist gewollt und legt sich innert Sekunden. Anhaltender, scharfer Schmerz gehört nicht dazu: Sag Bescheid, die Nadel wird sofort korrigiert oder entfernt."
    ...
    "related": [
      {
        "href": "/standorte/frauenfeld/",
        "label": "Standort Frauenfeld",
        "cat": "Standort"
      },
      {
        "href": "/standorte/frauenfeld/kosten/",
        "label": "Kosten & Krankenkasse",
        "cat": "Kosten"
      },
      {
  ...
  },
  {
    ...
    "related": [
      ...
      {
        "href": "/beschwerden/cluster-kopfschmerzen/",
        "label": "Cluster-Kopfschmerzen",
        "cat": "Beschwerde"
      },
      {
        "href": "/koerpersignale/druck-im-kopf-ohne-kopfschmerzen/",
        "label": "Druck im Kopf ohne Kopfschmerzen",
        "cat": "Körpersignal"
      },
      {
        "href": "/wissen/akupunktur-bei-kopfschmerzen/",
        "label": "Akupunktur bei Kopfschmerzen: Studienlage",
        "cat": "Artikel"
      },
      {
        "href": "/wissen/triggerpunkte-verstehen-loesen/",
