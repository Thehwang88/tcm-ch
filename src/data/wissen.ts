...
export const wissen: Wissen[] = [
  ...
  },
  {
    ...
    "dateModified": "2026-07-06",
    "lastReviewed": "2026-06-18",
    "bodyHtml": "<h2>Was sind Dauernadeln?</h2><p>Dauernadeln, auch Dauerakupunkturnadeln genannt, sind sehr kleine Akupunkturnadeln, die nach dem Setzen mit einem kleinen Pflaster fixiert werden und mehrere Tage an Ort und Stelle bleiben. Anders als bei der klassischen <a href=\"/therapien/akupunktur/\">Akupunktur</a>, bei der die Nadeln nach der Sitzung wieder entfernt werden, wirken Dauernadeln über einen längeren Zeitraum. Sie sind nur wenige Millimeter lang, werden flach unter die Haut gesetzt und sind im Alltag meist kaum spürbar. Gedacht sind sie als Verlängerung einer Behandlung, nicht als Ersatz für eine vollständige Sitzung. Wie wir sie in der Praxis einsetzen, liest du auf unserer Seite zu <a href=\"/therapien/dauernadeln/\">Akupunktur mit Dauernadeln</a>.</p><h2>Wie Dauernadeln wirken</h2><p>Der gesetzte Punkt wird durch die Nadel dauerhaft leicht gereizt, auch zwischen den Behandlungsterminen. So lässt sich die Wirkung einer Akupunktur über mehrere Tage verlängern, ohne dass du täglich in die Praxis kommen musst. Der Reiz ist schwächer, aber konstanter als bei einer einzelnen Sitzung. Genau das ist die Idee dahinter: Statt eines kurzen, starken Impulses ein leiser, anhaltender. Für Menschen mit einem vollen Alltag ist das ein praktischer Weg, eine Behandlung zwischen den Terminen weiterlaufen zu lassen. Wie stark du davon profitierst, ist individuell und lässt sich vorher nicht garantieren.</p><h2>Dauernadeln im Ohr</h2><p>Die Ohrakupunktur ist der häufigste Einsatzbereich für Dauernadeln. Am Ohr liegen viele Reizpunkte dicht beieinander, und die kleinen Nadeln lassen sich dort gut fixieren und tragen. Weil das Ohr im Alltag wenig bewegt wird, bleiben die Nadeln meist ruhig an ihrem Platz. Genutzt wird die Ohrakupunktur mit Dauernadeln unter anderem begleitend bei Stress, bei Schlafthemen und in Programmen zur Raucherentwöhnung. Manche Menschen drücken die Nadel im Verlauf des Tages kurz an, um den Reiz zu verstärken. Wie stark der Effekt ausfällt, ist von Person zu Person verschieden.</p><h2>Wo Dauernadeln am Körper gesetzt werden</h2><p>Neben dem Ohr werden Dauernadeln an Körperpunkten gesetzt, zum Beispiel am Rücken bei wiederkehrenden Verspannungen, an den Schultern oder in der Nähe eines schmerzenden Gelenks. Welche Punkte sinnvoll sind, hängt von deiner Beschwerde ab und wird individuell festgelegt. An Stellen, die im Alltag stark bewegt werden, halten die Nadeln kürzer. Wer keine Nadeln möchte, findet mit <a href=\"/therapien/ear-seeds/\">Ear Seeds</a> eine nadelfreie Alternative, die über Druck statt über eine Nadel wirkt.</p><h2>Wie lange bleiben Dauernadeln?</h2><p>Üblich sind zwei bis sieben Tage. Im Ohr bleiben sie oft drei bis fünf Tage, an Körperpunkten je nach Beschwerde und Belastung etwas kürzer oder länger. Länger als von deiner Therapeutin empfohlen solltest du sie nicht tragen, weil dann das Risiko für Reizungen steigt. Beim nächsten Termin werden die Nadeln entfernt, oder du bekommst eine Anleitung, wie du das selbst machst. Wenn sich eine Nadel früher löst, ist das kein Grund zur Sorge.</p><h2>Für welche Beschwerden Dauernadeln eingesetzt werden</h2><p>In der TCM werden Dauernadeln traditionell begleitend eingesetzt, unter anderem bei chronischen und wiederkehrenden Schmerzen, bei Rücken- und Nackenbeschwerden, bei innerer Unruhe und Stress sowie unterstützend bei der Raucherentwöhnung. Sie ersetzen keine ärztliche Behandlung, sondern ergänzen sie. Bei akuten oder unklaren Beschwerden gehört immer zuerst eine ärztliche Abklärung. Mehr zu Beschwerden im Rückenbereich liest du auf unserer Seite zu <a href=\"/beschwerden/rueckenschmerzen/\">Rückenschmerzen</a>, mehr zu Verspannungen im Nacken bei <a href=\"/beschwerden/nackenschmerzen/\">Nackenschmerzen</a>.</p><h2>Dauernadeln bei Stress und Schlaf</h2><p>Ein häufiger Grund für Ohr-Dauernadeln ist der Wunsch, im Alltag ruhiger zu werden. Der leichte, anhaltende Reiz wird von manchen Menschen als beruhigend erlebt und lässt sich mit einer breiteren Behandlung kombinieren, etwa bei stressbedingter Anspannung oder Ein- und Durchschlafproblemen. Auch hier gilt: Die Nadeln können begleiten, sie sind aber kein Ersatz für Erholung, Bewegung und einen geregelten Tagesablauf. Wie du Schlafprobleme sonst angehen kannst, liest du auf unserer Seite zu <a href=\"/beschwerden/schlafstoerungen/\">Schlafstörungen</a>.</p><h2>Woher die Ohr-Dauernadeln kommen</h2><p>Die Arbeit mit Punkten am Ohr geht auf die Beobachtung zurück, dass sich bestimmte Areale am Ohr Körperregionen zuordnen lassen. Daraus hat sich die Ohrakupunktur als eigener Ansatz entwickelt, der heute auch mit Dauernadeln arbeitet. Für dich als Patientin ist vor allem eines wichtig: Die Methode ist gut etabliert, wird mit sterilem Einwegmaterial durchgeführt und von einer ausgebildeten Fachperson gesetzt. Den historischen Hintergrund muss niemand kennen, um von einer sauberen, sorgfältigen Behandlung zu profitieren.</p><h2>Dauernadeln im Alltag und beim Sport</h2><p>Weil Dauernadeln flach fixiert sind, stören sie die meisten Alltagsbewegungen kaum. Bei starkem Schwitzen, intensivem Sport oder häufigem Duschen können sich Pflaster und Nadel jedoch früher lösen. Wenn du weisst, dass ein sportlich intensiver Tag ansteht, sag es vorher, dann wählen wir Stelle und Fixierung entsprechend. Klemmt oder drückt eine Nadel unangenehm, entferne sie und melde dich, damit wir beim nächsten Mal anpassen können.</p><h2>Was die Studienlage zeigt</h2><p>Dauernadeln sind eine Form der Akupunktur, deshalb lohnt ein Blick auf die Forschung zur Akupunktur allgemein. In einer grossen Auswertung von Einzeldaten aus randomisierten Studien schnitt Akupunktur bei chronischen Schmerzen besser ab als keine Behandlung und besser als eine Scheinbehandlung; der Unterschied zur Scheinakupunktur war allerdings eher klein (<a href=\"https://pubmed.ncbi.nlm.nih.gov/29198932/\" target=\"_blank\" rel=\"noopener\">Vickers et al., 2018</a>). Für chronische, unspezifische Rückenschmerzen fand eine Cochrane-Übersicht kurzfristig einen kleinen Effekt auf Schmerz und Beweglichkeit gegenüber keiner Behandlung, bei allerdings begrenzter Sicherheit der Evidenz (<a href=\"https://pubmed.ncbi.nlm.nih.gov/33306198/\" target=\"_blank\" rel=\"noopener\">Mu et al., Cochrane 2020</a>). Für die Vorbeugung von Migräne fand eine Cochrane-Übersicht, dass Akupunktur die Anfallshäufigkeit senken kann (<a href=\"https://pubmed.ncbi.nlm.nih.gov/27351677/\" target=\"_blank\" rel=\"noopener\">Linde et al., Cochrane 2016</a>). Speziell zu Dauernadeln ist die Studienlage dünn, die meisten Studien untersuchen die klassische Akupunktur. Ehrlich gesagt: Akupunktur kann bei manchen Beschwerden unterstützen, ein sicheres Ergebnis oder gar eine Heilung lässt sich daraus nicht ableiten.</p><h2>Ablauf einer Behandlung</h2><p>Zuerst besprechen wir dein Anliegen und wählen die passenden Punkte aus. Die Stelle wird gereinigt und desinfiziert, dann setzt die Fachperson die Dauernadel mit sterilem Einwegmaterial und fixiert sie mit einem kleinen Pflaster. Du bekommst Hinweise zur Pflege und zur Tragedauer sowie einen Hinweis, worauf du achten solltest. Eine Sitzung dauert meist 20 bis 30 Minuten. Oft werden Dauernadeln am Ende einer regulären Akupunkturbehandlung gesetzt, damit die Wirkung bis zum nächsten Termin anhält.</p><h2>Dauernadeln in Kombination mit anderen Methoden</h2><p>Dauernadeln stehen selten allein. Häufig sind sie Teil eines Plans aus klassischer Akupunktur und, wenn passend, weiteren Methoden wie <a href=\"/therapien/tuina/\">Tuina</a> oder <a href=\"/therapien/schroepfen/\">Schröpfen</a>. Der Gedanke dahinter ist einfach: In der Praxis wird intensiver behandelt, und die Dauernadel trägt einen Teil des Reizes über die Tage bis zum nächsten Termin. Welche Kombination sinnvoll ist, entscheidet die Therapeutin gemeinsam mit dir, abhängig von Beschwerde, Verlauf und Verträglichkeit.</p><h2>Mögliche Nebenwirkungen und wann Vorsicht gilt</h2><p>Bei fachgerechter Anwendung mit sterilem Einwegmaterial gelten Dauernadeln als risikoarm. Möglich sind eine leichte Rötung, ein leichtes Druckgefühl oder Juckreiz an der Stelle, selten eine Reaktion auf das Pflaster. Bei Schmerzen, starker Rötung, Wärme oder anderen Anzeichen einer Entzündung entferne die Nadel und melde dich bei deiner Therapeutin. Nicht geeignet sind Dauernadeln unter anderem bei bekannter Metall- oder Pflasterallergie sowie bei Blutgerinnungsstörungen. Das Setzen gehört wegen Punktwahl und Hygiene in die Hände einer ausgebildeten Fachperson.</p><h2>Selbst entfernen und Pflege</h2><p>Halte die Stelle sauber und trocken und reibe nicht stark daran. Duschen ist in der Regel kein Problem. Löst sich eine Nadel, entferne sie und entsorge sie sicher, zum Beispiel in einem festen Behälter. Das Entfernen am Ende der Tragezeit kannst du nach Anleitung deiner Therapeutin meist problemlos selbst übernehmen, indem du das Pflaster vorsichtig ablöst. Bei Unsicherheit lass die Nadeln bis zum nächsten Termin in der Praxis entfernen.</p><h2>Was Dauernadeln nicht können</h2><p>Dauernadeln sind ein sanftes, begleitendes Werkzeug, kein Wundermittel. Sie ersetzen weder eine ärztliche Diagnose noch eine notwendige schulmedizinische Behandlung. Bei starken, neuen oder sich verschlechternden Beschwerden gehört immer eine ärztliche Abklärung an den Anfang. Wir sagen dir ehrlich, wenn wir den Eindruck haben, dass ein anderer Weg für dich besser passt, statt eine Behandlung fortzusetzen, die dir nichts bringt.</p><h2>Was du von einer Behandlung erwarten kannst</h2><p>Realistisch ist eine Begleitung, kein Wunder. Manche Menschen spüren nach dem Setzen rasch eine gewisse Entspannung, bei anderen zeigt sich erst über mehrere Anwendungen ein Unterschied. Wie viele Sitzungen sinnvoll sind, hängt davon ab, ob deine Beschwerden akut oder chronisch sind, und wird individuell festgelegt. Wichtig ist ein offener Austausch, damit wir die Behandlung an deinen Verlauf anpassen können.</p><h2>Kosten und Krankenkasse</h2><p>Dauernadeln werden im Rahmen einer Akupunkturbehandlung gesetzt. Bei EMR- oder ASCA-anerkannten Therapeutinnen beteiligen sich viele Zusatzversicherungen mit 80 bis 100 Prozent, die Grundversicherung deckt es nicht. Prüfe am besten vorab deine Police oder frag uns, wir sagen dir, worauf du achten solltest. Wie die Abrechnung über die Zusatzversicherung läuft, liest du auf unserer Seite zur <a href=\"/krankenkassen/\">Krankenkasse</a>.</p><p><em>Verfasst von Corinna Reinhart, dipl. TCM-Therapeutin mit EMR- und ASCA-Anerkennung.</em></p>",
    "faqs": [
      {
