...
export interface Standort {
  ...
  extraBlock?: string;
  /** Optional raw-HTML Kompakt-Block ("auf einen Blick"), im CRO-Flow direkt nach dem Trust-Strip. */
...
export const standorte: Record<string, Standort> = {
  kreuzlingen: {
    ...
    hero: {
      ...
      locationHook: 'Romanshornerstrasse 1, 8280 Kreuzlingen · Mo–Fr 7:30–19:30, Sa 7:30–16:30 · Partnerklinik von Praxis Hwang',
    },
    nap: {
    ...
    intro: {
      body: '<h2>Deine TCM-Praxis in Kreuzlingen</h2><p>Kreuzlingen ist der langjährige Hauptstandort unseres Netzwerks. Hier hat TCM.ch angefangen, hier ist über die Jahre der grösste Teil unserer Erfahrung entstanden, und von hier aus sind die weiteren Praxen in der Ostschweiz gewachsen. Im Alltag merkst du das an eingespielten Abläufen, an einem Team, das sich kennt, und daran, dass sich auch kurzfristig noch ein Termin einrichten lässt.</p><p>TCM.ch Kreuzlingen ist eine <strong>Partnerklinik von <a href="https://hwang.ch/" target="_blank" rel="noopener">Praxis Hwang</a></strong>: Der Standort verbindet die langjährige lokale Erfahrung von Praxis Hwang mit dem TCM.ch Netzwerk für moderne Chinesische Medizin.</p><p>Behandelt wird an der Romanshornerstrasse 1, wenige Gehminuten vom Bahnhof Kreuzlingen. Das Angebot umfasst Akupunktur, Tuina, Schröpfen, Gua Sha, Moxibustion, Elektroakupunktur und individuell zusammengestellte Kräuterrezepturen. Wer chinesische Medizin in Kreuzlingen sucht, bekommt bei uns das vollständige Spektrum unter einem Dach statt einer einzelnen Methode.</p><p>Eine <strong>TCM-Praxis</strong> ist am Ende so gut wie die Leute, die darin arbeiten. Unsere Therapeut:innen sind EMR- und ASCA-anerkannt, dein Akupunkteur hat eine geprüfte Ausbildung und eine eigene ZSR-Nummer. Deshalb übernimmt die Zusatzversicherung je nach Modell 80 bis 100 Prozent der Kosten. Was dein Vertrag hergibt, prüfen wir kostenlos, bevor du das erste Mal kommst. Alle Zahlen im Detail stehen unter <a href="/standorte/kreuzlingen/kosten/">Akupunktur Kosten Kreuzlingen</a>.</p>',
      einzugsgebiet: '<h2>Wer aus der Region zu uns kommt</h2><p>Der grösste Teil unserer Patient:innen wohnt in Kreuzlingen selbst, in der Innenstadt, in Egelshofen, Kurzrickenbach oder Bernrain. Dazu kommen Menschen aus <strong>Tägerwilen</strong>, <strong>Bottighofen</strong>, <strong>Münsterlingen</strong> und <strong>Ermatingen</strong>, für die wir schlicht die nächste Adresse mit vollem TCM-Angebot sind. Wohnst du weiter Richtung mittlerer Thurgau, ist oft <a href="/standorte/frauenfeld/">TCM Frauenfeld</a> die kürzere Anfahrt.</p><p>Ein eigenes Thema ist <strong>Konstanz</strong>. Von der Grenze bis zu uns sind es wenige Minuten, und wir behandeln seit Jahren regelmässig deutsche Patient:innen und Grenzgänger:innen. Behandelt wird in der Schweiz, abgerechnet über eine Schweizer Zusatzversicherung: Wer hier arbeitet und entsprechend versichert ist, reicht die Rechnung genauso ein wie alle anderen. Ohne Schweizer Zusatzversicherung zahlst du selbst, zu denselben Tarifen und ohne Aufschlag. Was in deinem Fall gilt, klären wir vor dem ersten Termin, damit du weisst, woran du bist.</p>'
    },
    anfahrt: {
    ...
    ablaufBlock: true,
    faqs: [
      { q: 'Was bedeutet Partnerklinik von Praxis Hwang?', a: 'TCM.ch Kreuzlingen ist eine Partnerklinik von Praxis Hwang. Behandelt wirst du bei TCM.ch an der Romanshornerstrasse 1; der Standort verbindet die langjährige lokale Erfahrung von Praxis Hwang mit den Standards, der Terminvergabe und der Krankenkassen-Abrechnung des TCM.ch Netzwerks. Für dich ändert sich dadurch nichts am Ablauf: Termin anfragen, behandeln lassen, über die Zusatzversicherung abrechnen.' },
  ...
  "frauenfeld": {
    ...
    "seo": {
      ...
      "description": "TCM und Akupunktur in Frauenfeld, Rheinstrasse 25: Partnerklinik von Praxis Hwang mit EMR-/ASCA-anerkannten Therapeut:innen. Krankenkasse 80 bis 100%. Termin online anfragen.",
      "h1": "TCM & Akupunktur in <em>Frauenfeld</em>",
      "schemaName": "TCM.ch Frauenfeld"
    },
    "aufEinenBlick": "<section class='section' style='padding:32px 0;background:var(--bg)'><div class='wrap reveal'><div class='section-label'>TCM Frauenfeld auf einen Blick</div><div style='display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:14px;margin-top:14px'><div style='background:#fff;border:1px solid var(--border);border-radius:16px;padding:18px 20px'><div style='font-family:var(--font-sans);font-weight:800;font-size:15px;color:var(--black);margin-bottom:4px'>Adresse & Zeiten</div><div style='font-size:14.5px;color:var(--mid);line-height:1.55'>Rheinstrasse 25, 8500 Frauenfeld, wenige Minuten vom Bahnhof.<br>Mo bis Fr 7:30 bis 19:30, Sa 7:30 bis 16:30.</div></div><div style='background:#fff;border:1px solid var(--border);border-radius:16px;padding:18px 20px'><div style='font-family:var(--font-sans);font-weight:800;font-size:15px;color:var(--black);margin-bottom:4px'>Behandlungen</div><div style='font-size:14.5px;color:var(--mid);line-height:1.55'>Akupunktur, Tuina, Schröpfen, Gua Sha, Moxibustion, Elektroakupunktur, medizinische Massage, Kräuterrezepturen.</div></div><div style='background:#fff;border:1px solid var(--border);border-radius:16px;padding:18px 20px'><div style='font-family:var(--font-sans);font-weight:800;font-size:15px;color:var(--black);margin-bottom:4px'>Vertrauen & Kosten</div><div style='font-size:14.5px;color:var(--mid);line-height:1.55'>Partnerklinik von Praxis Hwang. EMR- und ASCA-anerkannt, Zusatzversicherung übernimmt je nach Modell 80 bis 100 Prozent.</div></div></div><div style='margin-top:16px'><button type='button' onclick='openContactForm()' class='btn-primary'>Termin anfragen <span aria-hidden='true'>→</span></button></div></div></section>",
    "hero": {
      "banner": "Standort Frauenfeld",
      "lead": "Zeit zum Zuhören, bevor wir behandeln.",
      "sub": "Unser Team begleitet dich hier vor Ort, mit Erfahrung aus der Schweiz und Südkorea, viel Zeit und allen Methoden, die wir kennen. Egal, worum es geht.",
      "image": "/images/hero-main.webp",
      "locationHook": "Rheinstrasse 25, 8500 Frauenfeld · Mo–Fr 7:30–19:30, Sa 7:30–16:30 · Partnerklinik von Praxis Hwang"
    },
    "nap": {
    ...
    "ablaufBlock": true,
    "faqs": [
      { "q": "Was bedeutet Partnerklinik von Praxis Hwang?", "a": "TCM.ch Frauenfeld ist eine Partnerklinik von Praxis Hwang. Behandelt wirst du bei TCM.ch an der Rheinstrasse 25; der Standort verbindet die langjährige lokale Erfahrung von Praxis Hwang mit den Standards, der Terminvergabe und der Krankenkassen-Abrechnung des TCM.ch Netzwerks. Am Ablauf für dich ändert das nichts: Termin anfragen, behandeln lassen, über die Zusatzversicherung abrechnen." },
  ...
  "zuerich-oerlikon": {
    ...
    "intro": {
      "body": "<h2>TCM Zürich Oerlikon, Akupunktur, Tuina &amp; TCM-Klinik in Zürich Nord</h2><p><strong>Neu ab 1. Dezember 2026:</strong> Unsere Praxis an der <strong>Ohmstrasse 14</strong> liegt wenige Gehminuten vom <strong>Bahnhof Oerlikon</strong>, einem der grössten ÖV-Knoten der Schweiz. Ob du mit der S-Bahn aus Zürich, dem Glattal oder von Winterthur kommst: Du bist in wenigen Minuten bei uns.</p><p>Einen Überblick über Akupunktur und Chinesische Medizin in der ganzen Stadt findest du auf unserer Seite zu <a href='/akupunktur-tcm-zuerich/'>TCM Zürich</a>. Unseren Schwester-Standort findest du in <a href='/standorte/zuerich-hoengg/'>Höngg</a>.</p><p>Wir bieten das vollständige Spektrum der Traditionellen Chinesischen Medizin: <strong>Akupunktur</strong>, TCM-Beratung, <strong>Schröpfen</strong>, <strong>Tuina-Massage</strong>, <strong>chinesische Kräutertherapie</strong>, Moxibustion und Elektroakupunktur. Alle Therapeut:innen sind EMR- und ASCA-anerkannt. Medizinische und entspannende Behandlungen findest du gesammelt unter <a href='/massage-oerlikon/'>Massage in Oerlikon</a> und stadtweit unter <a href='/massage-zuerich/'>Massage in Zürich</a>.</p>",
      "einzugsgebiet": "<h2>Einzugsgebiet – Patient:innen aus ganz Zürich Nord und dem Glattal</h2><p>Zu unseren Patient:innen zählen Menschen aus <strong>Oerlikon</strong>, <strong>Seebach</strong>, <strong>Schwamendingen</strong>, <strong>Affoltern</strong> und dem Kreis 11/12. Auch aus dem <strong>Glattal</strong>, Wallisellen, Opfikon, Kloten, Bassersdorf, Rümlang und Regensdorf, kommen Patient:innen regelmässig zu uns. Die zentrale Lage am Bahnhof Oerlikon macht uns für ganz Zürich Nord und das Zürcher Unterland erreichbar. Für <strong>Neu-Oerlikon</strong> und den <strong>Glattpark</strong> sind wir die nächstgelegene Praxis, und wer beim Hallenstadion oder der Messe arbeitet, erreicht uns in der Mittagspause.</p><p style=\"display:block\">Diese Praxis gehört zum Netzwerk <a href=\"/akupunktur-tcm-zuerich/\">TCM Zürich</a> mit Standorten in der ganzen Stadt. Preise und Krankenkassen-Details: <a href=\"/standorte/zuerich/kosten/\">Akupunktur-Kosten in Zürich</a>.</p>"
    },
    "anfahrt": {
