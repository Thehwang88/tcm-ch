...
export const therapyCards: Record<string, TherapyCard> = {
  akupunktur: { name: 'Akupunktur', tagline: 'Aktiviert Selbstheilungskräfte durch gezielte Nadelstimulation', time: '45–60 Min', ins: 'Zusatzversicherung', img: '/images/img-c69a8f9ce7f8.webp', w: 1120, h: 746, objectPos: 'center 30%' },
  gesichtsakupunktur: { name: 'Gesichtsakupunktur', tagline: 'Harmonisiert Meridiane im Gesicht – wirkt bei Stress, Spannung', time: '40–50 Min', ins: 'Zusatzversicherung', img: '/images/img-f7c771cf39ed.webp', w: 630, h: 840, objectPos: 'center 82%' },
  ...
  tuina: { name: 'Tuina-Massage', tagline: 'Medizinische TCM-Massage entlang der Meridiane', time: '45–60 Min', ins: 'Zusatzversicherung', img: '/images/img-2a8cecc37898.webp', w: 1120, h: 746, objectPos: 'center 30%' },
  ...
  'gua-sha': { name: 'Gua Sha', tagline: 'Traditionelles Schaben aktiviert Qi-Fluss und löst Blockaden', time: '30–40 Min', ins: 'Zusatzversicherung', img: '/images/img-0e38a23a362e.webp', w: 1120, h: 746, objectPos: 'center 20%' },
  physiotherapie: { name: 'Physiotherapie', tagline: 'Gezielte Bewegungs- und Manualtherapie für nachhaltige Heilung', time: '40–60 Min', ins: 'Grundversicherung', img: '/images/img-6a11d6de445a.webp', w: 1120, h: 746, objectPos: 'center 25%' },
};
